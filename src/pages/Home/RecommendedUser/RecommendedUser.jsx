         ...
         {/*Suggested User */}
           <div className="w-full h-auto my-8">
               ...
               <h6 className="text-sm text-gray-400 font-medium">
                ...
                <Link to="/" className="text-xs font-semibold text-gray-300 hover:text-gray-600">See All</Link>
               </div>
               {/* All user */}
                  {recommendedUserData.map((user) => (
                      ...
                      className="w-12 h-12 rounded-full object-cover" />
                        <div className="flex items-start gap-y-0 flex-col">
                           <p className="text-[0.9rem] text-white font-medium mb-0">{user.username}
                           </p>
                           <h6 className="text-xs text-gray-500 font-normal">Suggested for you</h6>
                        </div>
                      </Link>
                      <Link to="/" className="text-[0.855rem] text-blue-500 hover:text-gray-200">{user.follow}
                      </Link>
                      </div>
                  ))}
           </div>
           ...
           <div className="w-full h-auto">
             ...
             <p className="text-sm text-[#5b5b5b] font-normal">&copy; 2024 INSTAGRAME FROM META
             </p>
           </div>
      </div>
    </>
